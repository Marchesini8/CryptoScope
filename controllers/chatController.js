...
exports.index = async (req, res) => res.render('pages/chat', { title: 'Chat IA cripto - CryptoRadar', description: 'Tire duvidas educativas sobre criptomoedas.', history: await Chat.list(req.user?.id) });
