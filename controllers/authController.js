...
exports.showLogin = (req, res) => res.render('pages/login', { title: 'Entrar - CryptoScope', description: 'Acesse sua carteira cripto.', errors: [], mode: 'login' });
exports.showRegister = (req, res) => res.render('pages/login', { title: 'Cadastro - CryptoScope', description: 'Crie sua conta no CryptoScope.', errors: [], mode: 'register' });
